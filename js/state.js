...
'use strict';
        ...
        // 纪念日
        let anniversaries = [];
        let currentAnniversaryType = 'love';
        ...
        const DOMElements = {
            ...
            apiModal: {
                ...
                closeBtn: document.getElementById('close-api')
            },
            anniversaryModal: {
            ...
            anniversaryAnimation: {
                container: document.getElementById('anniversary-animation-container')
            }
        };