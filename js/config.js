...
'use strict';
        ...
        const DEEPSEEK_DEFAULT_TEMPERATURE = 0.8;
        const DEEPSEEK_DEFAULT_MAX_TOKENS = 1024;
        const UPLOAD_SERVER_URL = window.location.hostname === 'localhost'
            ? 'http://localhost:3001'
            : '';
...
window.UPLOAD_SERVER_URL = UPLOAD_SERVER_URL;
window.HISTORY_BATCH_SIZE = HISTORY_BATCH_SIZE;
